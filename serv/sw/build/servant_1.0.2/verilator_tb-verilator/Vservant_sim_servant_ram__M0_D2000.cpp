...
VL_CTOR_IMP(Vservant_sim_servant_ram__M0_D2000) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vservant_sim_servant_ram__M0_D2000::__Vconfigure(Vservant_sim__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

Vservant_sim_servant_ram__M0_D2000::~Vservant_sim_servant_ram__M0_D2000() {
}

//--------------------
// Internal Methods

VL_INLINE_OPT void Vservant_sim_servant_ram__M0_D2000::_sequent__TOP__servant_sim__dut__ram__1(Vservant_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vservant_sim_servant_ram__M0_D2000::_sequent__TOP__servant_sim__dut__ram__1\n"); );
    ...
    VL_SIG16(__Vdlyvdim0__mem__v0,10,0);
    VL_SIG16(__Vdlyvdim0__mem__v1,10,0);
    VL_SIG16(__Vdlyvdim0__mem__v2,10,0);
    VL_SIG16(__Vdlyvdim0__mem__v3,10,0);
    // Body
	...
	__Vdlyvdim0__mem__v0 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
					  >> 2U));
    }
	...
	__Vdlyvdim0__mem__v1 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
					  >> 2U));
    }
	...
	__Vdlyvdim0__mem__v2 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
					  >> 2U));
    }
	...
	__Vdlyvdim0__mem__v3 = (0x7ffU & (vlSymsp->TOP__servant_sim__dut.__PVT__wb_mem_adr 
					  >> 2U));
    }
...
VL_INLINE_OPT void Vservant_sim_servant_ram__M0_D2000::_sequent__TOP__servant_sim__dut__ram__2(Vservant_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vservant_sim_servant_ram__M0_D2000::_sequent__TOP__servant_sim__dut__ram__2\n"); );
    Vservant_sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vservant_sim_servant_ram__M0_D2000::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vservant_sim_servant_ram__M0_D2000::_ctor_var_reset\n"); );
    // Body
